...
let oneHour = 3600 * 1000; // 1 hour in milliseconds

// Generate initial data (for example, 24 hours of random data)
for (var i = 0; i < 24; i++) {
  data.push({
    name: new Date(now - i * oneHour).toISOString(),
    value: [
      new Date(now - i * oneHour).toISOString(),
